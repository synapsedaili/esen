...
def process_image_to_fill(img_path):
    # ANTIALIAS hatasını çözmek için PIL ile açıp boyutlandırıyoruz
    ...
    # Yeni Pillow sürümlerinde ANTIALIAS yerine LANCZOS kullanılır
    ...
    # Geçici dosyaya kaydet ve ImageClip olarak yükle
    temp_path = f"temp_{random.randint(1000,9999)}.jpg"
    pil_img.save(temp_path, quality=95)
    clip = ImageClip(temp_path)
    # Temizlik için dosyayı silebiliriz ama MoviePy okumadan silmemek lazım
    return clip
