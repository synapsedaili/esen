...
# --- KRİTİK MAYMUN YAMASI (Monkey Patch) ---
# MoviePy 1.0.3'ün Pillow 10+ ile çalışabilmesi için ANTIALIAS'ı sisteme geri yüklüyoruz.
...
def process_image_to_fill(img_path):
    ...
    # Yukarıdaki yama sayesinde Image.ANTIALIAS burada patlamaz
